...
1. How to Build
	...
	- edit Makefile
		...
		$ export ARCH=arm
		$ mkdir output
		$ make -C $(pwd) O=output ARCH=arm CROSS_COMPILE=$(pwd)/../prebuilts/gcc/linux-x86/arm/arm-eabi-4.8/bin/arm-eabi- msm8916_sec_defconfig VARIANT_DEFCONFIG=msm8916_sec_j3lte_kor_defconfig SELINUX_DEFCONFIG=selinux_defconfig
		$ make -C $(pwd) O=output ARCH=arm CROSS_COMPILE=$(pwd)/../prebuilts/gcc/linux-x86/arm/arm-eabi-4.8/bin/arm-eabi-
